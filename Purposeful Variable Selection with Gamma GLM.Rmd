...
sales_ratios_glm <- testing$LastSalePrice/predict(step1_model,newdata=testing,type="response")
require(stats)
median_glm <- median(sales_ratios_glm)
mean((sales_ratios_glm-median_glm)/median_glm) #0.0347 < 0.15
```
...
#coefficient of dispersion
sales_ratios_lm <- testing$LastSalePrice/predict(linear_model,newdata=testing)
median_lm <- median(sales_ratios_lm)
mean((sales_ratios_lm-median_lm)/median_lm) #0.0417 > 0.15
...
#assessment sales ratio
mean((testing$LastSalePrice/predict(linear_model_2,newdata=testing))) #1.02 

#coefficient of dispersion
sales_ratios_lm_2 <- testing$LastSalePrice/predict(linear_model_2,newdata=testing)
median_lm_2 <- median(sales_ratios_lm_2)
mean((sales_ratios_lm_2-median_lm_2)/median_lm_2) #0.0634 < 0.15
```
